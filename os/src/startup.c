...
//Add more below if wish to
    ...
    (uint32_t)&__isr_reserved42,
    (uint32_t)&__isr_reserved43,
    (uint32_t)&__isr_reserved44,
    (uint32_t)&__isr_reserved45,
    (uint32_t)&__isr_reserved46,
    (uint32_t)&__isr_reserved47,
    (uint32_t)&__isr_reserved48,
    (uint32_t)&__isr_sdmmc,
    (uint32_t)&__isr_reserved50,
    (uint32_t)&__isr_spi3,
    (uint32_t)&__isr_uart4,
    (uint32_t)&__isr_reserved53,
