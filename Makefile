...
C_SOURCES_TIMER := stm32_ll_Timer/src/stm32_ll_timers.c stm32_ll_Timer/src/stm32_ll_timers_cfg.c
C_SOURCES_USART := stm32_ll_uxart/src/stm32_ll_usart.c
C_SOURCES_DMA := stm32_ll_dma/src/stm32_ll_dma.c
...
OBJS_USART := $(patsubst %.c,%.o,$(C_SOURCES_USART))
OBJS_DMA := $(patsubst %.c,%.o,$(C_SOURCES_DMA))
# --- All Object Files to Link ---
# This variable combines all object files from all modules into a single list
ALL_OBJS := $(OBJS_OS) $(OBJS_GPIO) $(OBJS_RCC) $(OBJS_SYSCFG) $(OBJS_EXTI) $(OBJS_FLASH) $(OBJS_TIMER) $(OBJS_USART) $(OBJS_DMA)
...
submodules_build:
	...
	$(MAKE) -C stm32_ll_uxart all
	$(MAKE) -C stm32_ll_dma all
...
submodules_clean:
	...
	$(MAKE) -C stm32_ll_uxart clean
	$(MAKE) -C stm32_ll_dma clean
