...
// RCC_CR MSION
enum { RCC_CR_SETTING_MSION_OFF = 0, RCC_CR_SETTING_MSION_ON = 1 };

// RCC_CR MSIRDY
enum { RCC_CR_SETTING_MSIRDY_NOTREADY = 0, RCC_CR_SETTING_MSIRDY_READY = 1 };

// RCC_CR MSIPLLEN
enum { RCC_CR_SETTING_MSIPLLEN_OFF = 0, RCC_CR_SETTING_MSIPLLEN_ON = 1 };

// RCC_CR MSIRGSEL
enum { RCC_CR_SETTING_MSIRGSEL_CSR = 0, RCC_CR_SETTING_MSIRGSEL_CR = 1 };

// RCC_CR MSIRANGE (MSI clock ranges, see RM0394 Table 17)
enum {
    RCC_CR_SETTING_MSIRANGE_0 = 0x0, // 100 kHz
    RCC_CR_SETTING_MSIRANGE_1 = 0x1, // 200 kHz
    RCC_CR_SETTING_MSIRANGE_2 = 0x2, // 400 kHz
    RCC_CR_SETTING_MSIRANGE_3 = 0x3, // 800 kHz
    RCC_CR_SETTING_MSIRANGE_4 = 0x4, // 1 MHz
    RCC_CR_SETTING_MSIRANGE_5 = 0x5, // 2 MHz
    RCC_CR_SETTING_MSIRANGE_6 = 0x6, // 4 MHz
    RCC_CR_SETTING_MSIRANGE_7 = 0x7, // 8 MHz
    RCC_CR_SETTING_MSIRANGE_8 = 0x8, // 16 MHz
    RCC_CR_SETTING_MSIRANGE_9 = 0x9, // 24 MHz
    RCC_CR_SETTING_MSIRANGE_10 = 0xA, // 32 MHz
    RCC_CR_SETTING_MSIRANGE_11 = 0xB  // 48 MHz
    // 0xC-0xF: Reserved
};

// RCC_CR HSION
enum { RCC_CR_SETTING_HSION_OFF = 0, RCC_CR_SETTING_HSION_ON = 1 };

// RCC_CR HSIKERON
enum { RCC_CR_SETTING_HSIKERON_OFF = 0, RCC_CR_SETTING_HSIKERON_ON = 1 };

// RCC_CR HSIRDY
enum { RCC_CR_SETTING_HSIRDY_NOTREADY = 0, RCC_CR_SETTING_HSIRDY_READY = 1 };

// RCC_CR HSIASFS
enum { RCC_CR_SETTING_HSIASFS_OFF = 0, RCC_CR_SETTING_HSIASFS_ON = 1 };

// RCC_CR HSEON
enum { RCC_CR_SETTING_HSEOSC_OFF = 0, RCC_CR_SETTING_HSEOSC_ON = 1 };

// RCC_CR HSERDY
enum { RCC_CR_SETTING_HSERDY_NOTREADY = 0, RCC_CR_SETTING_HSERDY_READY = 1 };

// RCC_CR HSEBYP
enum { RCC_CR_SETTING_HSEBYP_OFF = 0, RCC_CR_SETTING_HSEBYP_ON = 1 };

// RCC_CR CSSON
enum { RCC_CR_SETTING_CSSON_OFF = 0, RCC_CR_SETTING_CSSON_ON = 1 };

// RCC_CR PLL_ON
enum { RCC_CR_SETTING_PLL_OFF = 0, RCC_CR_SETTING_PLL_ON = 1 };

// RCC_CR PLL_RDY
enum { RCC_CR_SETTING_PLL_NOTREADY = 0, RCC_CR_SETTING_PLL_READY = 1 };

// RCC_CR PLLSAI1ON
enum { RCC_CR_SETTING_PLLSAI1_OFF = 0, RCC_CR_SETTING_PLLSAI1_ON = 1 };

// RCC_CR PLLSAI1RDY
enum { RCC_CR_SETTING_PLLSAI1_NOTREADY = 0, RCC_CR_SETTING_PLLSAI1_READY = 1 };
...
enum {
    RCC_CFGR_HPRE_DIV1_SETTING   = 0x0,
...
enum {
    RCC_CFGR_PPRE1_DIV1_SETTING  = 0x0,
...
enum {
    RCC_CFGR_PPRE2_DIV1_SETTING  = 0x0,
...
enum {
    RCC_PLLCFGR_PLLM_DIV1_SETTING = 0x0,
    RCC_PLLCFGR_PLLM_DIV2_SETTING = 0x1,
    RCC_PLLCFGR_PLLM_DIV3_SETTING = 0x2,
    RCC_PLLCFGR_PLLM_DIV4_SETTING = 0x3,
    RCC_PLLCFGR_PLLM_DIV5_SETTING = 0x4,
    RCC_PLLCFGR_PLLM_DIV6_SETTING = 0x5,
    RCC_PLLCFGR_PLLM_DIV7_SETTING = 0x6,
    RCC_PLLCFGR_PLLM_DIV8_SETTING = 0x7
};

// RCC_PLLCFGR PLLN (Main PLL multiplication factor for VCO, 8 bits: 8..86)
// Use direct value, e.g. .PLLN = 20

// RCC_PLLCFGR PLLP (Main PLL division factor for PLLP output)
enum {
    RCC_PLLCFGR_PLLP_DIV7_SETTING  = 0x0,
    RCC_PLLCFGR_PLLP_DIV17_SETTING = 0x1
};
...
enum { RCC_AHB2RSTR_GPOIERST_NO_SETTING = 0, RCC_AHB2RSTR_GPOIERST_RESET_SETTING = 1 };
...
enum { RCC_APB1RSTR1_CANRST_NO_SETTING = 0, RCC_APB1RSTR1_CANRST_RESET_SETTING = 1 };
...
enum { RCC_APB1RSTR1_OPAMPRST_NO_SETTING = 0, RCC_APB1RSTR1_OPAMPRST_RESET_SETTING = 1 };
...
enum { RCC_APB1RSTR2_LPUART1RST_NO = 0, RCC_APB1RSTR2_LPUART1RST_RESET = 1 };

// RCC_APB1RSTR2 I2C4RST (I2C4 reset)
enum { RCC_APB1RSTR2_I2C4RST_NO = 0, RCC_APB1RSTR2_I2C4RST_RESET = 1 };

// RCC_APB1RSTR2 SWPMI1RST (SWPMI1 reset)
enum { RCC_APB1RSTR2_SWPMI1RST_NO = 0, RCC_APB1RSTR2_SWPMI1RST_RESET = 1 };

// RCC_APB1RSTR2 LPTIM2RST (LPTIM2 reset)
enum { RCC_APB1RSTR2_LPTIM2RST_NO = 0, RCC_APB1RSTR2_LPTIM2RST_RESET = 1 };
...
enum { RCC_APB2RSTR_SYSCFGRST_NO = 0, RCC_APB2RSTR_SYSCFGRST_RESET = 1 };

// RCC_APB2RSTR SDMMCRST (SDMMC reset)
enum { RCC_APB2RSTR_SDMMCRST_NO = 0, RCC_APB2RSTR_SDMMCRST_RESET = 1 };

// RCC_APB2RSTR TIM1RST (TIM1 timer reset)
enum { RCC_APB2RSTR_TIM1RST_NO = 0, RCC_APB2RSTR_TIM1RST_RESET = 1 };

// RCC_APB2RSTR SPI1RST (SPI1 reset)
enum { RCC_APB2RSTR_SPI1RST_NO = 0, RCC_APB2RSTR_SPI1RST_RESET = 1 };

// RCC_APB2RSTR UART1RST (USART1 reset)
enum { RCC_APB2RSTR_UART1RST_NO = 0, RCC_APB2RSTR_UART1RST_RESET = 1 };

// RCC_APB2RSTR TIM15RST (TIM15 timer reset)
enum { RCC_APB2RSTR_TIM15RST_NO = 0, RCC_APB2RSTR_TIM15RST_RESET = 1 };

// RCC_APB2RSTR TIM16RST (TIM16 timer reset)
enum { RCC_APB2RSTR_TIM16RST_NO = 0, RCC_APB2RSTR_TIM16RST_RESET = 1 };

// RCC_APB2RSTR SA1RST (SAI1 reset)
enum { RCC_APB2RSTR_SA1RST_NO = 0, RCC_APB2RSTR_SA1RST_RESET = 1 };

// RCC_APB2RSTR DFSDM1RST (DFSDM1 reset)
enum { RCC_APB2RSTR_DFSDM1RST_NO = 0, RCC_APB2RSTR_DFSDM1RST_RESET = 1 };
...
enum { RCC_AHB1ENR_DMA1_EN_OFF = 0, RCC_AHB1ENR_DMA1_EN_ON = 1 };

// RCC_AHB1ENR DMA2_EN (DMA2 clock enable)
enum { RCC_AHB1ENR_DMA2_EN_OFF = 0, RCC_AHB1ENR_DMA2_EN_ON = 1 };

// RCC_AHB1ENR FLASH_EN (Flash memory interface clock enable)
enum { RCC_AHB1ENR_FLASH_EN_OFF = 0, RCC_AHB1ENR_FLASH_EN_ON = 1 };

// RCC_AHB1ENR CRC_EN (CRC clock enable)
enum { RCC_AHB1ENR_CRC_EN_OFF = 0, RCC_AHB1ENR_CRC_EN_ON = 1 };

// RCC_AHB1ENR TSC_EN (Touch sensing controller clock enable)
enum { RCC_AHB1ENR_TSC_EN_OFF = 0, RCC_AHB1ENR_TSC_EN_ON = 1 };
...
enum { RCC_AHB2ENR_GPIOA_EN_OFF = 0, RCC_AHB2ENR_GPIOA_EN_ON = 1 };

// RCC_AHB2ENR GPIOB_EN (GPIOB clock enable)
enum { RCC_AHB2ENR_GPIOB_EN_OFF = 0, RCC_AHB2ENR_GPIOB_EN_ON = 1 };

// RCC_AHB2ENR GPIOC_EN (GPIOC clock enable)
enum { RCC_AHB2ENR_GPIOC_EN_OFF = 0, RCC_AHB2ENR_GPIOC_EN_ON = 1 };

// RCC_AHB2ENR GPIOD_EN (GPIOD clock enable)
enum { RCC_AHB2ENR_GPIOD_EN_OFF = 0, RCC_AHB2ENR_GPIOD_EN_ON = 1 };

// RCC_AHB2ENR GPIOE_EN (GPIOE clock enable)
enum { RCC_AHB2ENR_GPIOE_EN_OFF = 0, RCC_AHB2ENR_GPIOE_EN_ON = 1 };

// RCC_AHB2ENR GPIOH_EN (GPIOH clock enable)
enum { RCC_AHB2ENR_GPIOH_EN_OFF = 0, RCC_AHB2ENR_GPIOH_EN_ON = 1 };

// RCC_AHB2ENR ADC_EN (ADC clock enable)
enum { RCC_AHB2ENR_ADC_EN_OFF = 0, RCC_AHB2ENR_ADC_EN_ON = 1 };

// RCC_AHB2ENR AES_EN (AES clock enable)
enum { RCC_AHB2ENR_AES_EN_OFF = 0, RCC_AHB2ENR_AES_EN_ON = 1 };

// RCC_AHB2ENR RNG_B (RNG clock enable)
enum { RCC_AHB2ENR_RNG_B_OFF = 0, RCC_AHB2ENR_RNG_B_ON = 1 };
...
enum { RCC_AHB3ENR_QSPI_EN_OFF = 0, RCC_AHB3ENR_QSPI_EN_ON = 1 };
...
enum { RCC_APB1ENR1_TIM2_EN_OFF = 0, RCC_APB1ENR1_TIM2_EN_ON = 1 };

// RCC_APB1ENR1 TIM3_EN (TIM3 clock enable)
enum { RCC_APB1ENR1_TIM3_EN_OFF = 0, RCC_APB1ENR1_TIM3_EN_ON = 1 };

// RCC_APB1ENR1 TIM6_EN (TIM6 clock enable)
enum { RCC_APB1ENR1_TIM6_EN_OFF = 0, RCC_APB1ENR1_TIM6_EN_ON = 1 };

// RCC_APB1ENR1 TIM7_EN (TIM7 clock enable)
enum { RCC_APB1ENR1_TIM7_EN_OFF = 0, RCC_APB1ENR1_TIM7_EN_ON = 1 };

// RCC_APB1ENR1 LCDEN (LCD clock enable)
enum { RCC_APB1ENR1_LCDEN_OFF = 0, RCC_APB1ENR1_LCDEN_ON = 1 };

// RCC_APB1ENR1 RTCAPBEM (RTC APB clock enable)
enum { RCC_APB1ENR1_RTCAPBEM_OFF = 0, RCC_APB1ENR1_RTCAPBEM_ON = 1 };

// RCC_APB1ENR1 WWDGEN (Window watchdog clock enable)
enum { RCC_APB1ENR1_WWDGEN_OFF = 0, RCC_APB1ENR1_WWDGEN_ON = 1 };

// RCC_APB1ENR1 SPI2_EN (SPI2 clock enable)
enum { RCC_APB1ENR1_SPI2_EN_OFF = 0, RCC_APB1ENR1_SPI2_EN_ON = 1 };

// RCC_APB1ENR1 SPI3_EN (SPI3 clock enable)
enum { RCC_APB1ENR1_SPI3_EN_OFF = 0, RCC_APB1ENR1_SPI3_EN_ON = 1 };

// RCC_APB1ENR1 USART2_EN (USART2 clock enable)
enum { RCC_APB1ENR1_USART2_EN_OFF = 0, RCC_APB1ENR1_USART2_EN_ON = 1 };

// RCC_APB1ENR1 USART3_EN (USART3 clock enable)
enum { RCC_APB1ENR1_USART3_EN_OFF = 0, RCC_APB1ENR1_USART3_EN_ON = 1 };

// RCC_APB1ENR1 UART4_EN (UART4 clock enable)
enum { RCC_APB1ENR1_UART4_EN_OFF = 0, RCC_APB1ENR1_UART4_EN_ON = 1 };

// RCC_APB1ENR1 I2C1_EN (I2C1 clock enable)
enum { RCC_APB1ENR1_I2C1_EN_OFF = 0, RCC_APB1ENR1_I2C1_EN_ON = 1 };

// RCC_APB1ENR1 I2C2_EN (I2C2 clock enable)
enum { RCC_APB1ENR1_I2C2_EN_OFF = 0, RCC_APB1ENR1_I2C2_EN_ON = 1 };

// RCC_APB1ENR1 I2C3_EN (I2C3 clock enable)
enum { RCC_APB1ENR1_I2C3_EN_OFF = 0, RCC_APB1ENR1_I2C3_EN_ON = 1 };

// RCC_APB1ENR1 CRS_EN (CRS clock enable)
enum { RCC_APB1ENR1_CRS_EN_OFF = 0, RCC_APB1ENR1_CRS_EN_ON = 1 };

// RCC_APB1ENR1 CAN1EN (CAN1 clock enable)
enum { RCC_APB1ENR1_CAN1EN_OFF = 0, RCC_APB1ENR1_CAN1EN_ON = 1 };

// RCC_APB1ENR1 USBFSEN (USB FS clock enable)
enum { RCC_APB1ENR1_USBFSEN_OFF = 0, RCC_APB1ENR1_USBFSEN_ON = 1 };

// RCC_APB1ENR1 PWREN (PWR interface clock enable)
enum { RCC_APB1ENR1_PWREN_OFF = 0, RCC_APB1ENR1_PWREN_ON = 1 };

// RCC_APB1ENR1 DACEN (DAC clock enable)
enum { RCC_APB1ENR1_DACEN_OFF = 0, RCC_APB1ENR1_DACEN_ON = 1 };

// RCC_APB1ENR1 OPAMPEN (OPAMP clock enable)
enum { RCC_APB1ENR1_OPAMPEN_OFF = 0, RCC_APB1ENR1_OPAMPEN_ON = 1 };

// RCC_APB1ENR1 LPTIM1EN (LPTIM1 clock enable)
enum { RCC_APB1ENR1_LPTIM1EN_OFF = 0, RCC_APB1ENR1_LPTIM1EN_ON = 1 };
...
enum { RCC_APB1ENR2_LPUART1EN_OFF = 0, RCC_APB1ENR2_LPUART1EN_ON = 1 };

// RCC_APB1ENR2 I2C4EN (I2C4 clock enable)
enum { RCC_APB1ENR2_I2C4EN_OFF = 0, RCC_APB1ENR2_I2C4EN_ON = 1 };

// RCC_APB1ENR2 SWPMI1_EN (SWPMI1 clock enable)
enum { RCC_APB1ENR2_SWPMI1_EN_OFF = 0, RCC_APB1ENR2_SWPMI1_EN_ON = 1 };

// RCC_APB1ENR2 LPTIM2EN (LPTIM2 clock enable)
enum { RCC_APB1ENR2_LPTIM2EN_OFF = 0, RCC_APB1ENR2_LPTIM2EN_ON = 1 };
...
enum { RCC_APB2ENR_SYSCFG_EN_OFF = 0, RCC_APB2ENR_SYSCFG_EN_ON = 1 };

// RCC_APB2ENR FW_EN (Firewall clock enable)
enum { RCC_APB2ENR_FW_EN_OFF = 0, RCC_APB2ENR_FW_EN_ON = 1 };

// RCC_APB2ENR SDMMC1EN (SDMMC1 clock enable)
enum { RCC_APB2ENR_SDMMC1EN_OFF = 0, RCC_APB2ENR_SDMMC1EN_ON = 1 };

// RCC_APB2ENR TIM1EN (TIM1 timer clock enable)
enum { RCC_APB2ENR_TIM1EN_OFF = 0, RCC_APB2ENR_TIM1EN_ON = 1 };

// RCC_APB2ENR SPI1EN (SPI1 clock enable)
enum { RCC_APB2ENR_SPI1EN_OFF = 0, RCC_APB2ENR_SPI1EN_ON = 1 };

// RCC_APB2ENR USART1EN (USART1 clock enable)
enum { RCC_APB2ENR_USART1EN_OFF = 0, RCC_APB2ENR_USART1EN_ON = 1 };

// RCC_APB2ENR TIM15EN (TIM15 timer clock enable)
enum { RCC_APB2ENR_TIM15EN_OFF = 0, RCC_APB2ENR_TIM15EN_ON = 1 };

// RCC_APB2ENR TIME16EN (TIM16 timer clock enable)
enum { RCC_APB2ENR_TIME16EN_OFF = 0, RCC_APB2ENR_TIME16EN_ON = 1 };

// RCC_APB2ENR SAI1EN (SAI1 clock enable)
enum { RCC_APB2ENR_SAI1EN_OFF = 0, RCC_APB2ENR_SAI1EN_ON = 1 };

// RCC_APB2ENR DFSDM1EN (DFSDM1 clock enable)
enum { RCC_APB2ENR_DFSDM1EN_OFF = 0, RCC_APB2ENR_DFSDM1EN_ON = 1 };
...
enum { RCC_AHB1SMENR_DMA1SMEN_OFF = 0, RCC_AHB1SMENR_DMA1SMEN_ON = 1 };

// RCC_AHB1SMENR DMA2SMEN (DMA2 clock enable during Sleep)
enum { RCC_AHB1SMENR_DMA2SMEN_OFF = 0, RCC_AHB1SMENR_DMA2SMEN_ON = 1 };

// RCC_AHB1SMENR FLASHSMEN (Flash memory interface clock enable during Sleep)
enum { RCC_AHB1SMENR_FLASHSMEN_OFF = 0, RCC_AHB1SMENR_FLASHSMEN_ON = 1 };

// RCC_AHB1SMENR SRAM1EN (SRAM1 clock enable during Sleep)
enum { RCC_AHB1SMENR_SRAM1EN_OFF = 0, RCC_AHB1SMENR_SRAM1EN_ON = 1 };

// RCC_AHB1SMENR CRCSMEN (CRC clock enable during Sleep)
enum { RCC_AHB1SMENR_CRCSMEN_OFF = 0, RCC_AHB1SMENR_CRCSMEN_ON = 1 };

// RCC_AHB1SMENR TSCSMEN (Touch sensing controller clock enable during Sleep)
enum { RCC_AHB1SMENR_TSCSMEN_OFF = 0, RCC_AHB1SMENR_TSCSMEN_ON = 1 };
...
enum { RCC_AHB2SMENR_GPIOASMEN_OFF = 0, RCC_AHB2SMENR_GPIOASMEN_ON = 1 };

// RCC_AHB2SMENR GPIOBSMEN (GPIOB clock enable during Sleep)
enum { RCC_AHB2SMENR_GPIOBSMEN_OFF = 0, RCC_AHB2SMENR_GPIOBSMEN_ON = 1 };

// RCC_AHB2SMENR GPIOCSMEN (GPIOC clock enable during Sleep)
enum { RCC_AHB2SMENR_GPIOCSMEN_OFF = 0, RCC_AHB2SMENR_GPIOCSMEN_ON = 1 };

// RCC_AHB2SMENR GPIODSMEN (GPIOD clock enable during Sleep)
enum { RCC_AHB2SMENR_GPIODSMEN_OFF = 0, RCC_AHB2SMENR_GPIODSMEN_ON = 1 };

// RCC_AHB2SMENR GPOIESMEN (GPIOE clock enable during Sleep)
enum { RCC_AHB2SMENR_GPOIESMEN_OFF = 0, RCC_AHB2SMENR_GPOIESMEN_ON = 1 };

// RCC_AHB2SMENR GPIOHSMEN (GPIOH clock enable during Sleep)
enum { RCC_AHB2SMENR_GPIOHSMEN_OFF = 0, RCC_AHB2SMENR_GPIOHSMEN_ON = 1 };

// RCC_AHB2SMENR SRAM2SMEN (SRAM2 clock enable during Sleep)
enum { RCC_AHB2SMENR_SRAM2SMEN_OFF = 0, RCC_AHB2SMENR_SRAM2SMEN_ON = 1 };

// RCC_AHB2SMENR ADCSMEN (ADC clock enable during Sleep)
enum { RCC_AHB2SMENR_ADCSMEN_OFF = 0, RCC_AHB2SMENR_ADCSMEN_ON = 1 };

// RCC_AHB2SMENR AESMEN (AES clock enable during Sleep)
enum { RCC_AHB2SMENR_AESMEN_OFF = 0, RCC_AHB2SMENR_AESMEN_ON = 1 };

// RCC_AHB2SMENR RNGSMEN (RNG clock enable during Sleep)
enum { RCC_AHB2SMENR_RNGSMEN_OFF = 0, RCC_AHB2SMENR_RNGSMEN_ON = 1 };
...
enum { RCC_AHB3SMENR_QSPISMEN_OFF = 0, RCC_AHB3SMENR_QSPISMEN_ON = 1 };
...
enum { RCC_APB1SMENR1_TIM2SMEN_OFF = 0, RCC_APB1SMENR1_TIM2SMEN_ON = 1 };

// RCC_APB1SMENR1 TIM3SMEN (TIM3 clock enable during Sleep)
enum { RCC_APB1SMENR1_TIM3SMEN_OFF = 0, RCC_APB1SMENR1_TIM3SMEN_ON = 1 };

// RCC_APB1SMENR1 TIM6SMEN (TIM6 clock enable during Sleep)
enum { RCC_APB1SMENR1_TIM6SMEN_OFF = 0, RCC_APB1SMENR1_TIM6SMEN_ON = 1 };

// RCC_APB1SMENR1 TIM7SMEN (TIM7 clock enable during Sleep)
enum { RCC_APB1SMENR1_TIM7SMEN_OFF = 0, RCC_APB1SMENR1_TIM7SMEN_ON = 1 };

// RCC_APB1SMENR1 LCDSMEN (LCD clock enable during Sleep)
enum { RCC_APB1SMENR1_LCDSMEN_OFF = 0, RCC_APB1SMENR1_LCDSMEN_ON = 1 };

// RCC_APB1SMENR1 RTCAPBSMEN (RTC APB clock enable during Sleep)
enum { RCC_APB1SMENR1_RTCAPBSMEN_OFF = 0, RCC_APB1SMENR1_RTCAPBSMEN_ON = 1 };

// RCC_APB1SMENR1 WWDGSMEN (Window watchdog clock enable during Sleep)
enum { RCC_APB1SMENR1_WWDGSMEN_OFF = 0, RCC_APB1SMENR1_WWDGSMEN_ON = 1 };

// RCC_APB1SMENR1 SPI2SMEN (SPI2 clock enable during Sleep)
enum { RCC_APB1SMENR1_SPI2SMEN_OFF = 0, RCC_APB1SMENR1_SPI2SMEN_ON = 1 };

// RCC_APB1SMENR1 SPI3SMEN (SPI3 clock enable during Sleep)
enum { RCC_APB1SMENR1_SPI3SMEN_OFF = 0, RCC_APB1SMENR1_SPI3SMEN_ON = 1 };

// RCC_APB1SMENR1 USART2SMEN (USART2 clock enable during Sleep)
enum { RCC_APB1SMENR1_USART2SMEN_OFF = 0, RCC_APB1SMENR1_USART2SMEN_ON = 1 };

// RCC_APB1SMENR1 UART3SMEN (USART3 clock enable during Sleep)
enum { RCC_APB1SMENR1_UART3SMEN_OFF = 0, RCC_APB1SMENR1_UART3SMEN_ON = 1 };

// RCC_APB1SMENR1 UART4SMEN (UART4 clock enable during Sleep)
enum { RCC_APB1SMENR1_UART4SMEN_OFF = 0, RCC_APB1SMENR1_UART4SMEN_ON = 1 };

// RCC_APB1SMENR1 I2C1SMEN (I2C1 clock enable during Sleep)
enum { RCC_APB1SMENR1_I2C1SMEN_OFF = 0, RCC_APB1SMENR1_I2C1SMEN_ON = 1 };

// RCC_APB1SMENR1 I2C2SMEN (I2C2 clock enable during Sleep)
enum { RCC_APB1SMENR1_I2C2SMEN_OFF = 0, RCC_APB1SMENR1_I2C2SMEN_ON = 1 };

// RCC_APB1SMENR1 I2C3SMEN (I2C3 clock enable during Sleep)
enum { RCC_APB1SMENR1_I2C3SMEN_OFF = 0, RCC_APB1SMENR1_I2C3SMEN_ON = 1 };

// RCC_APB1SMENR1 CRSSMEN (CRS clock enable during Sleep)
enum { RCC_APB1SMENR1_CRSSMEN_OFF = 0, RCC_APB1SMENR1_CRSSMEN_ON = 1 };

// RCC_APB1SMENR1 CAN1SMEN (CAN1 clock enable during Sleep)
enum { RCC_APB1SMENR1_CAN1SMEN_OFF = 0, RCC_APB1SMENR1_CAN1SMEN_ON = 1 };

// RCC_APB1SMENR1 USBFSSMEN (USB FS clock enable during Sleep)
enum { RCC_APB1SMENR1_USBFSSMEN_OFF = 0, RCC_APB1SMENR1_USBFSSMEN_ON = 1 };

// RCC_APB1SMENR1 PWRSEMEN (PWR interface clock enable during Sleep)
enum { RCC_APB1SMENR1_PWRSEMEN_OFF = 0, RCC_APB1SMENR1_PWRSEMEN_ON = 1 };

// RCC_APB1SMENR1 DAC1SMEN (DAC clock enable during Sleep)
enum { RCC_APB1SMENR1_DAC1SMEN_OFF = 0, RCC_APB1SMENR1_DAC1SMEN_ON = 1 };

// RCC_APB1SMENR1 OPAMPSMEN (OPAMP clock enable during Sleep)
enum { RCC_APB1SMENR1_OPAMPSMEN_OFF = 0, RCC_APB1SMENR1_OPAMPSMEN_ON = 1 };

// RCC_APB1SMENR1 LPTIM1SMEN (LPTIM1 clock enable during Sleep)
enum { RCC_APB1SMENR1_LPTIM1SMEN_OFF = 0, RCC_APB1SMENR1_LPTIM1SMEN_ON = 1 };
...
enum { RCC_APB1SMENR2_LPUART1SMEN_OFF = 0, RCC_APB1SMENR2_LPUART1SMEN_ON = 1 };

// RCC_APB1SMENR2 SWPMI1SMEN (SWPMI1 clock enable during Sleep)
enum { RCC_APB1SMENR2_SWPMI1SMEN_OFF = 0, RCC_APB1SMENR2_SWPMI1SMEN_ON = 1 };

// RCC_APB1SMENR2 LPTIM2SMEN (LPTIM2 clock enable during Sleep)
enum { RCC_APB1SMENR2_LPTIM2SMEN_OFF = 0, RCC_APB1SMENR2_LPTIM2SMEN_ON = 1 };
...
enum { RCC_APB2SMENR_SYSCFGSMEEN_OFF = 0, RCC_APB2SMENR_SYSCFGSMEEN_ON = 1 };

// RCC_APB2SMENR SDMMC1SMEN (SDMMC1 clock enable during Sleep)
enum { RCC_APB2SMENR_SDMMC1SMEN_OFF = 0, RCC_APB2SMENR_SDMMC1SMEN_ON = 1 };

// RCC_APB2SMENR TIM1SMEN (TIM1 timer clock enable during Sleep)
enum { RCC_APB2SMENR_TIM1SMEN_OFF = 0, RCC_APB2SMENR_TIM1SMEN_ON = 1 };

// RCC_APB2SMENR SPI1SMEN (SPI1 clock enable during Sleep)
enum { RCC_APB2SMENR_SPI1SMEN_OFF = 0, RCC_APB2SMENR_SPI1SMEN_ON = 1 };

// RCC_APB2SMENR USART1SMEN (USART1 clock enable during Sleep)
enum { RCC_APB2SMENR_USART1SMEN_OFF = 0, RCC_APB2SMENR_USART1SMEN_ON = 1 };

// RCC_APB2SMENR TIM15SMEN (TIM15 timer clock enable during Sleep)
enum { RCC_APB2SMENR_TIM15SMEN_OFF = 0, RCC_APB2SMENR_TIM15SMEN_ON = 1 };

// RCC_APB2SMENR TIM16SMEN (TIM16 timer clock enable during Sleep)
enum { RCC_APB2SMENR_TIM16SMEN_OFF = 0, RCC_APB2SMENR_TIM16SMEN_ON = 1 };

// RCC_APB2SMENR SAI1SMEN (SAI1 clock enable during Sleep)
enum { RCC_APB2SMENR_SAI1SMEN_OFF = 0, RCC_APB2SMENR_SAI1SMEN_ON = 1 };
...
enum {
    RCC_CCIPR_USART3SEL_PCLK1 = 0x0,
    RCC_CCIPR_USART3SEL_SYSCLK = 0x1,
    RCC_CCIPR_USART3SEL_HSI16 = 0x2,
    RCC_CCIPR_USART3SEL_LSE = 0x3
};

// RCC_CCIPR UART4SEL (UART4 clock source selection)
enum {
    RCC_CCIPR_UART4SEL_PCLK1 = 0x0,
    RCC_CCIPR_UART4SEL_SYSCLK = 0x1,
...
enum {
    RCC_CCIPR_UART5SEL_PCLK1 = 0x0,
    RCC_CCIPR_UART5SEL_SYSCLK = 0x1,
...
enum {
    RCC_CCIPR_LPUART1SEL_PCLK1 = 0x0,
...
enum {
    RCC_CCIPR_SAI1SEL_PLLSAI1 = 0x0,
    RCC_CCIPR_SAI1SEL_PLLSAI2 = 0x1,
    RCC_CCIPR_SAI1SEL_PLL = 0x2,
...
enum {
    ...
    RCC_CCIPR_CLK48SEL_PLLSAI1 = 0x1,
    RCC_CCIPR_CLK48SEL_PLL = 0x2,
    RCC_CCIPR_CLK48SEL_MSI = 0x3
};

// RCC_CCIPR ADCSEL (ADC clock source selection)
enum {
    RCC_CCIPR_ADCSEL_NONE = 0x0,
    RCC_CCIPR_ADCSEL_PLLSAI1 = 0x1,
    RCC_CCIPR_ADCSEL_PLL = 0x2,
    RCC_CCIPR_ADCSEL_SYSCLK = 0x3
};

// RCC_CCIPR SWPMI1SEL (SWPMI1 clock source selection)
enum {
    RCC_CCIPR_SWPMI1SEL_PCLK1 = 0x0,
    RCC_CCIPR_SWPMI1SEL_HSI16 = 0x1
};
...
enum { RCC_BDCR_LSEON_OFF = 0, RCC_BDCR_LSEON_ON = 1 };

// RCC_BDCR LSERDY (LSE oscillator ready)
enum { RCC_BDCR_LSERDY_NOTREADY = 0, RCC_BDCR_LSERDY_READY = 1 };

// RCC_BDCR LSEBYP (LSE oscillator bypass)
enum { RCC_BDCR_LSEBYP_OFF = 0, RCC_BDCR_LSEBYP_ON = 1 };

// RCC_BDCR LSEDRV (LSE drive capability)
enum {
    RCC_BDCR_LSEDRV_LOW    = 0x0,
    RCC_BDCR_LSEDRV_MEDIUM = 0x1,
    RCC_BDCR_LSEDRV_HIGH   = 0x2,
    RCC_BDCR_LSEDRV_MAX    = 0x3
};

// RCC_BDCR LSECSSON (LSE clock security system enable)
enum { RCC_BDCR_LSECSSON_OFF = 0, RCC_BDCR_LSECSSON_ON = 1 };

// RCC_BDCR LSECSSD (LSE clock security system failure detected)
enum { RCC_BDCR_LSECSSD_NOFAIL = 0, RCC_BDCR_LSECSSD_FAIL = 1 };

// RCC_BDCR LSESYSDIS (LSE system clock disable)
enum { RCC_BDCR_LSESYSDIS_OFF = 0, RCC_BDCR_LSESYSDIS_ON = 1 };

// RCC_BDCR RTCSEL (RTC clock source selection)
enum {
    RCC_BDCR_RTCSEL_NONE = 0x0,
...
enum { RCC_BDCR_RTCEN_OFF = 0, RCC_BDCR_RTCEN_ON = 1 };

// RCC_BDCR BDRST (Backup domain software reset)
enum { RCC_BDCR_BDRST_NO = 0, RCC_BDCR_BDRST_RESET = 1 };

// RCC_BDCR LSCOEN (LSCO output enable)
enum { RCC_BDCR_LSCOEN_OFF = 0, RCC_BDCR_LSCOEN_ON = 1 };

// RCC_BDCR LSCOSEL (LSCO output selection)
enum {
    RCC_BDCR_LSCOSEL_LSI = 0,
    RCC_BDCR_LSCOSEL_LSE = 1
};
...
enum { RCC_CSR_LSION_OFF = 0, RCC_CSR_LSION_ON = 1 };

// RCC_CSR LSIRDY (LSI oscillator ready)
enum { RCC_CSR_LSIRDY_NOTREADY = 0, RCC_CSR_LSIRDY_READY = 1 };

// RCC_CSR LSIPREDIV (LSI prescaler)
enum { RCC_CSR_LSIPREDIV_DIV1 = 0, RCC_CSR_LSIPREDIV_DIV128 = 1 };

// RCC_CSR MSISRANGE (MSI range after standby)
enum {
    RCC_CSR_MSISRANGE_100KHZ  = 0x0,
    RCC_CSR_MSISRANGE_200KHZ  = 0x1,
    RCC_CSR_MSISRANGE_400KHZ  = 0x2,
    RCC_CSR_MSISRANGE_800KHZ  = 0x3,
    RCC_CSR_MSISRANGE_1MHZ    = 0x4,
    RCC_CSR_MSISRANGE_2MHZ    = 0x5,
    RCC_CSR_MSISRANGE_4MHZ    = 0x6,
    RCC_CSR_MSISRANGE_8MHZ    = 0x7,
    RCC_CSR_MSISRANGE_16MHZ   = 0x8,
    RCC_CSR_MSISRANGE_24MHZ   = 0x9,
    RCC_CSR_MSISRANGE_32MHZ   = 0xA,
    RCC_CSR_MSISRANGE_48MHZ   = 0xB
};

// RCC_CSR RMVF (Remove reset flag)
enum { RCC_CSR_RMVF_NO = 0, RCC_CSR_RMVF_CLEAR = 1 };

// RCC_CSR FWRSTF (Firewall reset flag)
enum { RCC_CSR_FWRSTF_NO = 0, RCC_CSR_FWRSTF_SET = 1 };

// RCC_CSR OBLRSTF (Option byte loader reset flag)
enum { RCC_CSR_OBLRSTF_NO = 0, RCC_CSR_OBLRSTF_SET = 1 };

// RCC_CSR PINRSTF (PIN reset flag)
enum { RCC_CSR_PINRSTF_NO = 0, RCC_CSR_PINRSTF_SET = 1 };

// RCC_CSR BORRSTF (BOR reset flag)
enum { RCC_CSR_BORRSTF_NO = 0, RCC_CSR_BORRSTF_SET = 1 };

// RCC_CSR SFTRSTF (Software reset flag)
enum { RCC_CSR_SFTRSTF_NO = 0, RCC_CSR_SFTRSTF_SET = 1 };

// RCC_CSR IWWGRSTF (Independent window watchdog reset flag)
enum { RCC_CSR_IWWGRSTF_NO = 0, RCC_CSR_IWWGRSTF_SET = 1 };

// RCC_CSR WWDGRSTF (Window watchdog reset flag)
enum { RCC_CSR_WWDGRSTF_NO = 0, RCC_CSR_WWDGRSTF_SET = 1 };

// RCC_CSR LPPWRRSTF (Low-power reset flag)
enum { RCC_CSR_LPPWRRSTF_NO = 0, RCC_CSR_LPPWRRSTF_SET = 1 };
...
enum { RCC_CRRCR_HSI48ON_OFF = 0, RCC_CRRCR_HSI48ON_ON = 1 };

// RCC_CRRCR HSI48RDY (HSI48 oscillator ready)
enum { RCC_CRRCR_HSI48RDY_NOTREADY = 0, RCC_CRRCR_HSI48RDY_READY = 1 };
...
enum {
    RCC_CCIPR2_I2C4SEL_PCLK1 = 0x0,
    RCC_CCIPR2_I2C4SEL_SYSCLK = 0x1,
