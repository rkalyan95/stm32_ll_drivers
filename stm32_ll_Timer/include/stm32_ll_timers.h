...
typedef enum
{
    TIMER_UPDATEINTER_ENABLE_DMA=TIM_DIER_UIE_Pos,
    TIMER_CNTCMP1_INTER_ENABLE_DMA=TIM_DIER_CC1IE_Pos,
    TIMER_CNTCMP2_INTER_ENABLE_DMA=TIM_DIER_CC2IE_Pos,
    TIMER_CNTCMP3_INTER_ENABLE_DMA=TIM_DIER_CC3IE_Pos,
    TIMER_CNTCMP4_INTER_ENABLE_DMA=TIM_DIER_CC4IE_Pos,
    TIMER_TRIGINTER_ENABLE_DMA=TIM_DIER_TIE_Pos,
    TIMER_DMARQST_ENABLE_DMA=TIM_DIER_UDE_Pos,
    TIMER_CNTCMP1_DMA_ENABLE_DMA=TIM_DIER_CC1DE_Pos,
    TIMER_CNTCMP2_DMA_ENABLE_DMA=TIM_DIER_CC2DE_Pos,
    TIMER_CNTCMP3_DMA_ENABLE_DMA=TIM_DIER_CC3DE_Pos,
    TIMER_CNTCMP4_DMA_ENABLE_DMA=TIM_DIER_CC4DE_Pos,
    TIMER_TRIG_DMA_ENABLE_DMA=TIM_DIER_TDE_Pos,
